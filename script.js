...
function setupLanguage() {
  const translations = {
    sv: {
      ...
      navAbout: "Om appen",
      heroKicker: "Bygg din egen tidlösa receptsamling.",
      heroTitle: "Din personliga receptsamling",
      heroText:
        "Spara dina favoritrecept, organisera dem på ditt sätt och ha dem alltid nära till hands. Kom igång direkt — inget konto behövs.",
